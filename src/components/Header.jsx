            ...
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center justify-between ps-16">
                ...
                <form className="block w-1/3">
                    ...
                    <div className="relative">
                        ...
                        <input type="search" id="default-search" className="block w-full p-4 ps-10 text-sm text-gray-900 border border-Azul-oscuro rounded-lg bg-Beige focus:border-Azul-oscuro" placeholder="Busca globos, decoraciones..." required />
